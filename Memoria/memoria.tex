...
Para construir una web responsable, y que el diseño y zoom funcionen bien en dispositivos móviles y tablets, lo más importante es añadir  \texttt{<meta name="viewport" content="width=device-width", initial-scale="1.0" />} dentro de la cabecera \texttt{<head>}.
...
En nuestra barra de navegación, hemos añadido la línea \texttt{<div class="collapse navbar-collapse navbar-ex1-collapse">} en el HTML, que agrupa los enlaces de navegación en un menú desplegable.\\
